...
/**
 * Classe Technique permet la connexion � la base de donn�es
 * Cet Objet doit  �tre unique pour 1 Application et retourne une Connexion Authentifi�e
 * A l'appelant pour les acc�s subsequents � la Base de donn�es.
 * Pattern : Singleton
 * 
 * @author Utilisateur
 *
